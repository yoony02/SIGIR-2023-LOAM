'''
Nowplaying Preprocessing Code (without and with window)
'''
...
parser.add_argument('--save-dir', default='nowplaying', help='save directory name')
...
with open('../raw/nowplaying.csv', "r") as f:
    ...
    for data in reader:
        ...
        curid = sessid
        item = int(data['ItemId']), int(data['Time'])
        curdate = ''
        # curdate = datetime.datetime.fromtimestamp(int(data['Time'])).strftime('%Y-%m-%d')
